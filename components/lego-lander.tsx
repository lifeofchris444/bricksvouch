...
const AFFILIATE_LINK = "https://trksy.org/aff_c?offer_id=4668&aff_id=26188"

const RED = "#D01012"
const RED_DEEP = "#8E0A0C"
const RED_BRIGHT = "#E8393B"
const INK = "#111213"
...
const CATEGORIES = [
  {
    t: "Sets & Playsets",
    d: "City, Friends, Technic, and licensed favorites.",
    icon: "M5 9.5h14v8a1 1 0 01-1 1H6a1 1 0 01-1-1v-8z M8.5 9.5V7.8a1.6 1.6 0 013.2 0v1.7 M14 9.5V7.8a1.6 1.6 0 013.2 0v1.7",
  },
  {
    t: "Bricks & Pieces",
    d: "Classic bricks, baseplates, and spare parts.",
    icon: "M4 10h16v7H4v-7z M7 10V8.4a1.5 1.5 0 013 0V10 M14 10V8.4a1.5 1.5 0 013 0V10 M4 17l3 3h10l3-3",
  },
  {
    t: "Minifigures & Collectibles",
    d: "Minifigure packs, keychains, and display sets.",
    icon: "M9.5 4.5h5v3h-5z M8 8h8v6H8V8z M8 14l-2 6 M16 14l2 6 M10 20h4",
  },
  {
    t: "Gifts & Advent Sets",
    d: "Birthday builds, gift boxes, and seasonal sets.",
    icon: "M3 9.5h18v10H3v-10z M3 9.5L12 4l9 5.5 M12 9.5v10 M8 14h2 M14 14h2",
  },
]
...
const AVATARS = [
  { src: "/avatars/lego-parent-1.png", alt: "Smiling mom with wavy brown hair in a mustard sweater" },
  { src: "/avatars/lego-parent-2.png", alt: "Smiling dad with a short beard in a blue button-down shirt" },
  { src: "/avatars/lego-parent-3.png", alt: "Smiling shopper with glasses in an olive t-shirt" },
]

function Icon({ d, className = "w-6 h-6", color = RED }: { d: string; className?: string; color?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
...
function CTAButton({
  ...
  return (
    <a
      ...
      style={dark ? { backgroundColor: RED, color: "#FFFFFF" } : { backgroundColor: "#FFFFFF", color: INK }}
    >
      {children}
      <svg
        viewBox="0 0 24 24"
  ...
  return (
    <div className="relative grid grid-cols-[3rem_1fr] md:grid-cols-[1fr_3.5rem_1fr] gap-x-4 md:gap-x-8 items-center pb-6 md:pb-8 last:pb-0">
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-black text-6xl lg:text-7xl leading-none select-none" style={{ color: "#F7E2E2" }}>
          0{index + 1}
        </span>
      </div>
      ...
      <div className="order-1 md:order-2 flex justify-center self-start md:self-center pt-1 md:pt-0">
        <div
          ...
          style={{
            ...
            borderColor: RED,
            color: "#FFFFFF",
            boxShadow: "0 8px 22px rgba(208,16,18,.35)",
          }}
        >
          {index + 1}
        </div>
      ...
      >
        <div className={`flex items-start gap-4 ${leftSide ? "md:flex-row-reverse md:text-right" : ""}`}>
          <div
            ...
            style={{ backgroundColor: "#FBE5E5" }}
          >
            <Icon d={step.icon} color={RED} className="w-6 h-6" />
          </div>
...
export default function LegoRewardLander() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased overflow-x-hidden font-sans" style={{ color: INK }}>
      <style>{`
        ...
        .card-shine { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(115deg, transparent 35%, rgba(208,16,18,0.05) 47%, rgba(255,255,255,0.55) 52%, transparent 65%); background-size: 260% 100%; animation: cardShine 7s ease-in-out infinite; }
        ...
        .cat-spark { position: absolute; top: 16px; right: 18px; color: #D01012; animation: sparkTwinkle 3.4s ease-in-out infinite; }
        ...
        .t-card:hover { transform: translateY(-6px); border-color: rgba(208,16,18,.35); box-shadow: 0 18px 44px rgba(208,16,18,.12); }
        .t-rail-fill { background: linear-gradient(180deg, #E8393B, #D01012); }
      ...
      <section
        ...
        style={{ background: `linear-gradient(170deg, ${RED_BRIGHT} 0%, ${RED} 45%, ${RED_DEEP} 100%)` }}
      >
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#E2564F" }} />
        <div className="orb w-80 h-80 top-1/3 -right-20" style={{ backgroundColor: "#8E0A0C", animationDelay: "-6s" }} />
        ...
        <div className="drifter right-[10%] top-[18%]" style={{ animationDelay: "-3s" }}>
          <Icon
            d="M4 10h16v7H4v-7z M7 10V8.4a1.5 1.5 0 013 0V10 M14 10V8.4a1.5 1.5 0 013 0V10"
            color="#fff"
            className="w-9 h-9"
          />
        </div>
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-12 pb-20 md:pt-20 md:pb-24 text-center">
          <div className="text-white">
            ...
            <h1 className="mt-6 font-black tracking-tight leading-[1.05] text-[2rem] min-[368px]:text-[2.3rem] min-[400px]:text-[2.4rem] min-[432px]:text-[2.6rem] min-[464px]:text-[2.8rem] min-[496px]:text-[3rem] min-[528px]:text-[3.2rem] min-[560px]:text-[3.5rem] min-[608px]:text-[3.75rem] sm:text-7xl text-balance">
              {"The LEGO Discounts They Don't Advertise"}
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/85 max-w-xl mx-auto leading-relaxed text-pretty">
              Discover how shoppers are unlocking hidden discount codes on building sets, bricks, minifigures, and gift
              sets.
            </p>
      ...
      <section className="relative overflow-hidden bg-white">
        <div className="relative mx-auto max-w-5xl px-6 py-16 md:py-20">
          <div className="text-center">
            <div className="text-sm font-semibold tracking-widest uppercase" style={{ color: RED }}>
              How it works
            </div>
              ...
              <div key={f.q} className="rounded-2xl bg-white border border-gray-200 shadow-sm">
                ...
                >
                  ...
                  <span
                    ...
                    style={{ backgroundColor: openFaq === i ? RED : "#F2F3F5" }}
                  >
                    <svg
                      viewBox="0 0 20 20"
      ...
      <section
        className="relative overflow-hidden"
        style={{ background: `linear-gradient(170deg, ${RED_BRIGHT} 0%, ${RED} 50%, ${RED_DEEP} 100%)` }}
      >
        {[
          { l: "6%", s: 5, d: 7, delay: 0 },
        ...
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#F07A72", opacity: 0.35 }} />
        <div
          className="orb w-80 h-80 -bottom-24 -right-16"
          style={{ backgroundColor: "#8E0A0C", animationDelay: "-5s" }}
        />
